                      ...
                      <div class="col-md-12">
                          <form action="{{url('create-trade')}}" method="POST">
                            ...
                            <div class="" id="first_step">
                              <input type="hidden" name="id" id="client_id" value="{{Auth::user()->client->id}}">
                            ...
                            <div class="" id="second_step" hidden>
                              <div class="form-group row">
                                <label id="splabel" for="name" class="col-4 col-form-label">Stock Price</label>
                                <div class="col-8">
...
$(document).ready(function()
{
  $("#proceed").click(function()
  {
     ...
     $("#splabel").text("Stock Price for "+company);
